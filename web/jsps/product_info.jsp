            ...
            <div class="container">
                <div class="row">
                    ...
                    <div style="margin:0 auto;width:950px;"style="float:left;">
                        <form  action="${pageContext.request.contextPath}/CartServlet?method=buyProduct" method="post">
                            <input  type="hidden" name="pro_id"  value="${requestScope.product.pro_id}"  />
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6" style="float: right;">
                                    ...
                                    <div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
                                        <div>${requestScope.product.pro_num}</div>
                                    </div>
                                    ...
                                    <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                                        ...
                                        <div style="margin:20px 0 10px 0;;text-align: center;">
                                            <a href="${pageContext.request.contextPath}/jsps/cart.jsp">
