            ...
            <c:forEach items="${sessionScope.cartMap}" var="entry">
                <tr>
                    ...
                    <td style="border-right: 1px solid gray;">
                        <a href="${pageContext.request.contextPath}/CartServlet?method=deleteProduct&&productId=${entry.key.pro_id}" class="delete">删除</a>
                    </td>
                </tr>
...
<%--            <tr>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    商品金额: <strong style="color:#ff6600;">￥<</strong>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    <a href="${pageContext.request.contextPath}/PayServlet?msg=payAll">
