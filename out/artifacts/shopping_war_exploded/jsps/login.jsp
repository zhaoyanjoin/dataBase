        ...
        <td>
            <table>
                <tr>
                    ...
                    <td>
                        <form style="margin-left: 200px;" method="post" action="../UserServlet?method=login">
                            <table style="background-color: white;width: 360px;height: 300px;border: 1px solid gray;text-align: center;">
                                <c:choose>
                                    <c:when test="${param.msg=='false'}">
                                        <tr>
                                            <td colspan="2">
                                                <span style="font-size:14px;color: brown">登录失败，账户或密码错误</span>
                                            </td>
                                        </tr>
                                    </c:when>
                                    <c:when test="${param.msg=='login'}">
                                        <tr>
                                            <td colspan="2">
                                                <span style="font-size:14px;color: brown">请您先登录</span>
                                            </td>
                                        </tr>
